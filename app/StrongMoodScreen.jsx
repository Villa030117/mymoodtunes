...
const StrongMoodScreen = () => {
  ...
  const fetchMusicList = async () => {
    setIsLoading(true);
    try {
      const response = await musicService.getMusicByCategory('strong');
      setMusicList(response);
      setFilteredMusic(response);
    } catch (error) {
      console.error('Error fetching strong music:', error);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.moodDescription}>
          Powerful and motivating tracks to boost your confidence and energy
        </Text>
          ...
          ListEmptyComponent={
            !isLoading && (
              <Text style={styles.emptyText}>
                No strong music available. Check back later!
              </Text>
            )
          }
        />
...
export default StrongMoodScreen;