...
const HappyMoodScreen = () => {
  ...
  const fetchMusicList = async () => {
    setIsLoading(true);
    try {
      const response = await musicService.getMusicByCategory('happy');
      setMusicList(response);
      setFilteredMusic(response);
    } catch (error) {
      console.error('Error fetching happy music:', error);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.moodDescription}>
          Uplifting tunes to brighten your day and keep your spirits high
        </Text>
          ...
          ListEmptyComponent={
            !isLoading && (
              <Text style={styles.emptyText}>
                No happy music available. Check back later!
              </Text>
            )
          }
        />
...
export default HappyMoodScreen;