...
const SummerMoodScreen = () => {
  ...
  const fetchMusicList = async () => {
    setIsLoading(true);
    try {
      const response = await musicService.getMusicByCategory('summer');
      setMusicList(response);
      setFilteredMusic(response);
    } catch (error) {
      console.error('Error fetching summer music:', error);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.moodDescription}>
          Vibrant and warm tracks to capture the essence of summer days
        </Text>
          ...
          ListEmptyComponent={
            !isLoading && (
              <Text style={styles.emptyText}>
                No summer music available. Check back later!
              </Text>
            )
          }
        />
...
export default SummerMoodScreen;