...
const FunMoodScreen = () => {
  ...
  const fetchMusicList = async () => {
    setIsLoading(true);
    try {
      const response = await musicService.getMusicByCategory('fun');
      setMusicList(response);
      setFilteredMusic(response);
    } catch (error) {
      console.error('Error fetching fun music:', error);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.moodDescription}>
          Lively and entertaining tracks to keep the good times rolling
        </Text>
          ...
          ListEmptyComponent={
            !isLoading && (
              <Text style={styles.emptyText}>
                No fun music available. Check back later!
              </Text>
            )
          }
        />
